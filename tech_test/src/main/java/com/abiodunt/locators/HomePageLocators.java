...
public class HomePageLocators {
    ...
    public WebElement minRangeInput;
    @FindBy(xpath = "//input[@data-qa-id='range-filter-input-max']")
    public WebElement maxRangeInput;
    @FindBy(xpath = "//*[ contains (text(), 'Algorithm' ) ]")
    public WebElement algorithmButton;
    @FindBy(xpath = "//*[ text() = 'PoW' ]")
    public WebElement powFilter;


    public String filterButtonLocator = "//*[ text() = 'Filters' ]";
